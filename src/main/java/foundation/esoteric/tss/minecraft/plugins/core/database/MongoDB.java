package foundation.esoteric.tss.minecraft.plugins.core.database;
...
import foundation.esoteric.tss.minecraft.plugins.core.database.collections.CollectionName;
